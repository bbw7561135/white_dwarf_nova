...
namespace 
{
	...
	size_t sort_point(Tessellation const& tess,Vector2D const& point)
	{
...
SimData::SimData(const InitialData& id,const Units& u,const CircularSection& domain,const Snapshot* const ss):
	...
	proctess_,
#endif // RICH_MPI
	tess_,outer_,pg_,ss ? ss->cells : init_cond_.second,eos_,
#ifdef Lagrangian
	point_motion_,
#else
	alt_point_motion_,
#endif // Lagrangian
	evc_,force_,tsf_,fc_,eu_,cu_,init_cond_.first
#ifdef RICH_MPI
	,&procupdate_
#endif // RICH_MPI
) 
